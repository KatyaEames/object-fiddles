...
favouriteThings[brand] = {brand: 'Mustang'};
...
favouriteThings.food = 'Lettuce';
favouriteThings.book = '50 Shades of Gray';
...
user.name = 'Katya Eames';
user.username = 'Koshka_E';
...
var users = [
  ...
  var user2 = {
    ...
    email: 'dean.winchester@yahoo.com',
    password: 'painfullyHeter0',
    username: 'Impala67'
  };
  var user3 = {
    name: 'Castiel',
    email: 'angeloftheLord@gmail.com',
    password: 'GrippedDeanTight',
    usernamr: 'AfraidOfFalling'
  }
];
...
for(var key in users) {
  if([email] === 'tylermcginnis33@gmail.com') {
    delete user;
  };
};
